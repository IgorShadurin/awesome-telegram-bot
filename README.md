...
- [Weight Goal Bot](https://t.me/my_weight_goal_bot) / @my_weight_goal_bot - 支持中文、英语和俄语的群组减重目标机器人，提供每周打卡、进度图、提醒和成就徽章。[开源代码](https://github.com/IgorShadurin/weight-telegram-bot)。
