...
- [Weight Goal Bot](https://t.me/my_weight_goal_bot) / @my_weight_goal_bot - 在群聊里用照片打卡每周体重，查看进度图、提醒和 53 周趣味成就；自然支持中文等 9 种语言。[Apache-2.0 开源代码](https://github.com/IgorShadurin/weight-telegram-bot)。
